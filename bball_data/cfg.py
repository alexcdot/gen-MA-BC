...
TEAM_SIZE = len(COORDS[OFFENSE]['xy']) // 2
CMAP_ALL = ['orange'] + ['b']*TEAM_SIZE + ['r']*TEAM_SIZE
CMAP_ALL_PLAYERS = ['b']*TEAM_SIZE + ['r']*TEAM_SIZE

CMAP_OFFENSE_FOCUSED_PLAYERS = ['b', 'c', 'g', 'm', 'y'] + ['r']*TEAM_SIZE
